...
class _EditLocationPageState extends State<EditLocationPage> {
  ...
  void initState() {
    ...
    _latController = TextEditingController(text: parts.first.trim());
    _lngController = TextEditingController(text: parts.length > 1 ? parts[1].trim() : '');
              ...
              children: [
                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      // Geofence Circle (radius adjusted based on slider value)
                      Center(
                        child: Container(
                          width: (40 + (_radius / 50) * 15).r,
                          height: (40 + (_radius / 50) * 15).r,
                          decoration: BoxDecoration(
                ...
                OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(color: dangerColor.withAlpha(128), width: 1.5.w),
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.delete_outline_rounded, size: 20.r, color: dangerColor),
                      SizedBox(width: 8.w),
                      Text(
                        'Delete location',
                        style: TextStyle(
